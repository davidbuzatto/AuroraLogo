...
public class AuroraLogoParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, DIR=8, ESQ=9, 
		CIM=10, BAI=11, VAP=12, COR=13, GIR=14, ENG=15, ENGE=16, DES=17, DESE=18, 
		TROG=19, ESC=20, LER=21, ABA=22, LEV=23, LIM=24, SE=25, ENT=26, SSE=27, 
		SEN=28, ENQ=29, REP=30, VEZ=31, PRETO=32, AZUL=33, CIANO=34, CINZA=35, 
		VERDE=36, MAGENTA=37, LARANJA=38, ROSA=39, VERMELHO=40, BRANCO=41, AMARELO=42, 
		ESCURO=43, CLARO=44, RAIZ=45, ATR=46, ATRA=47, ADI=48, ADIA=49, SUB=50, 
		SUBA=51, MUL=52, DIV=53, DIVA=54, MOD=55, MODA=56, IGU=57, IGUT=58, IGUA=59, 
		DIF=60, DIFT=61, DIFA=62, ME=63, MET=64, MEA=65, MEI=66, MEIT=67, MEIA=68, 
		MA=69, MAT=70, MAA=71, MAI=72, MAIT=73, MAIA=74, ELG=75, ELGT=76, OLG=77, 
		OLGT=78, NAO=79, NAOT=80, DOT=81, ID=82, INT=83, HEX=84, STRING=85, COMENTARIO=86, 
		COMENTARIO_LINHA=87, WS=88;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'('", "')'", "'{'", "'}'", "'['", "','", "']'", "'v\\u00E1 para direita em'", 
			"'v\\u00E1 para esquerda em'", "'v\\u00E1 para cima em'", "'v\\u00E1 para baixo em'", 
			"'v\\u00E1 para'", "'trocar cor para'", "'girar'", "'engrossar'", "'engrossar em'", 
			"'desengrossar'", "'desengrossar em'", "'trocar grossura para'", "'escrever'", 
			"'ler'", "'abaixar pincel'", "'levantar pincel'", "'limpar'", "'se'", 
			"'ent\\u00E3o'", "'sen\\u00E3o se'", "'sen\\u00E3o'", "'enquanto'", "'repita'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, null, "DIR", "ESQ", "CIM", 
			"BAI", "VAP", "COR", "GIR", "ENG", "ENGE", "DES", "DESE", "TROG", "ESC", 
			"LER", "ABA", "LEV", "LIM", "SE", "ENT", "SSE", "SEN", "ENQ", "REP", 
			"VEZ", "PRETO", "AZUL", "CIANO", "CINZA", "VERDE", "MAGENTA", "LARANJA", 
			"ROSA", "VERMELHO", "BRANCO", "AMARELO", "ESCURO", "CLARO", "RAIZ", "ATR", 
			"ATRA", "ADI", "ADIA", "SUB", "SUBA", "MUL", "DIV", "DIVA", "MOD", "MODA", 
			"IGU", "IGUT", "IGUA", "DIF", "DIFT", "DIFA", "ME", "MET", "MEA", "MEI", 
			"MEIT", "MEIA", "MA", "MAT", "MAA", "MAI", "MAIT", "MAIA", "ELG", "ELGT", 
			"OLG", "OLGT", "NAO", "NAOT", "DOT", "ID", "INT", "HEX", "STRING", "COMENTARIO", 
			"COMENTARIO_LINHA", "WS"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << DIR) | (1L << ESQ) | (1L << CIM) | (1L << BAI) | (1L << VAP) | (1L << COR) | (1L << GIR) | (1L << ENG) | (1L << ENGE) | (1L << DES) | (1L << DESE) | (1L << TROG) | (1L << ESC) | (1L << LER) | (1L << ABA) | (1L << LEV) | (1L << LIM) | (1L << SE) | (1L << ENQ) | (1L << REP))) != 0) || _la==ID );
			}
		}
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & ((1L << (ELG - 75)) | (1L << (ELGT - 75)) | (1L << (OLG - 75)) | (1L << (OLGT - 75)))) != 0)) {
				{
				{
				setState(86);
				_la = _input.LA(1);
				if ( !(((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & ((1L << (ELG - 75)) | (1L << (ELGT - 75)) | (1L << (OLG - 75)) | (1L << (OLGT - 75)))) != 0)) ) {
	...
	public final RelacaoContext relacao() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 57)) & ~0x3f) == 0 && ((1L << (_la - 57)) & ((1L << (IGU - 57)) | (1L << (IGUT - 57)) | (1L << (IGUA - 57)) | (1L << (DIF - 57)) | (1L << (DIFT - 57)) | (1L << (DIFA - 57)) | (1L << (ME - 57)) | (1L << (MET - 57)) | (1L << (MEA - 57)) | (1L << (MEI - 57)) | (1L << (MEIT - 57)) | (1L << (MEIA - 57)) | (1L << (MA - 57)) | (1L << (MAT - 57)) | (1L << (MAA - 57)) | (1L << (MAI - 57)) | (1L << (MAIT - 57)) | (1L << (MAIA - 57)))) != 0)) {
				{
				setState(94);
	...
	public static class TermoContext extends ParserRuleContext {
		...
		public List<TerminalNode> VEZ() { return getTokens(AuroraLogoParser.VEZ); }
		public TerminalNode VEZ(int i) {
			return getToken(AuroraLogoParser.VEZ, i);
		}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(110);
					_la = _input.LA(1);
					if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << VEZ) | (1L << MUL) | (1L << DIV) | (1L << DIVA) | (1L << MOD) | (1L << MODA))) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class SeSenaoSePContext extends ParserRuleContext {
		public TerminalNode SSE() { return getToken(AuroraLogoParser.SSE, 0); }
		public ExprBoolContext exprBool() {
			return getRuleContext(ExprBoolContext.class,0);
		}
		public TerminalNode ENT() { return getToken(AuroraLogoParser.ENT, 0); }
	...
	public static class MovimentarPontoContext extends MovimentarContext {
		public TerminalNode VAP() { return getToken(AuroraLogoParser.VAP, 0); }
	...
	public static class EngrossarContext extends ParserRuleContext {
		...
		public TerminalNode ENGE() { return getToken(AuroraLogoParser.ENGE, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
	...
	public static class TrocarGrossuraContext extends ParserRuleContext {
		public TerminalNode TROG() { return getToken(AuroraLogoParser.TROG, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
