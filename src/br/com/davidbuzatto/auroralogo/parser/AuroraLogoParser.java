...
public class AuroraLogoParser extends Parser {
	...
	public static final int
		...
		F_VABS=154, FC_CRI=155, FG_ARC=156, FG_CCU=157, FG_CIC=158, FG_CQD=159, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'teto'", "'valorAbsoluto'", "'criarCor'", "'arco'", "'curvaC\\u00FAbica'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"F_SENO", "F_TANG", "F_TANH", "F_TETO", "F_VABS", "FC_CRI", "FG_ARC", 
