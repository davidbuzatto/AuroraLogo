...
public class AuroraLogoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DESE", "DIR", "DIVM", "DO", "EM", "ENG", "ENQ", "ENT", "ESCO", "ESC", 
			"ESQ", "FAL", "FEC", "FUN", "GIR", "GRA", "GROS", "INCM", "INI", "LER", 
			"LEV", "LIM", "LIN", "MOV", "MULM", "NA", "PADR", "PARA", "PARR", "PI", 
			"PINC", "PIZ", "POR", "PREA", "PREE", "PREO", "QUAD", "REP", "SAI", "SE", 
			"SEN", "SOMM", "SUBM", "TART", "TER", "TROC", "USA", "VA", "VER", "VEZ", 
