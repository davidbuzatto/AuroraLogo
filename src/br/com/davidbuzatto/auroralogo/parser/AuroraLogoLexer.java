...
public class AuroraLogoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"COD", "COM", "CONT", "CON", "COR", "CUBI", "CUR", "CRA", "CRAA", "CRR", 
			"CRRA", "DCMM", "DE", "DES", "DESE", "DIAG", "DIR", "DIVM", "DO", "E", 
			"EM", "ENG", "ENQ", "ENT", "ESCO", "ESC", "ESQ", "FAL", "FEC", "FORM", 
			"FUN", "FUNC", "GIR", "GRA", "GROS", "INCM", "INI", "LER", "LEV", "LIM", 
			"LIN", "MEN", "MOV", "MULM", "NA", "NO", "PAS", "PADR", "PARA", "PARR", 
			"PI", "PINC", "PIZ", "POR", "PREE", "PUL", "QUAD", "RAD", "REP", "RET", 
			...
			"CLARO", "PA", "PX", "PY", "CARC", "CHAV", "COMP", "SUBS", "F_ACOS", 
