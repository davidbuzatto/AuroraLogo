...
public class AuroraLogoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"UNICODE", "ABA", "ABE", "ATE", "BAI", "CADA", "CAM", "CHAV", "CIM", 
			...
			"POR", "PREA", "PREE", "PREO", "PUL", "QUAD", "REP", "REPE", "SAI", "SE", 
			...
			"PX", "PY", "PA", "COMP", "F_ACOS", "F_ARRE", "F_ASEN", "F_ATAN", "F_CAPO", 
			...
			"F_VABS", "FG_ARC", "FG_CCU", "FG_CIC", "FG_CQD", "FG_ELI", "FG_EST", 
			"FG_POL", "FG_POR", "FG_QUA", "FG_RET", "FG_SEG", "ATR", "ATRA", "AC_A", 
			...
			"OLGT", "NAO", "NAOT", "DOT", "ID", "INT", "DEC", "CHEX", "CHAR", "STRING", 
