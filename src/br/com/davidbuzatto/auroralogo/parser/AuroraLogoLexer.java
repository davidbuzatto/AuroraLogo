...
public class AuroraLogoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"UNICODE", "PX", "PY", "PA", "ABA", "ABE", "ATE", "BAI", "CADA", "CAM", 
			"CHAV", "CIM", "COD", "COM", "COMP", "CONT", "CON", "COR", "CUBI", "CUR", 
			...
			"PINC", "PIZ", "POR", "PREA", "PREE", "PREO", "PUL", "QUAD", "REP", "REPE", 
			"SAI", "SE", "SEN", "SEM", "SOMM", "SUBM", "TART", "TER", "TROC", "USA", 
			...
			"NAO", "NAOT", "DOT", "ID", "INT", "DEC", "CHEX", "CHAR", "STRING", "COMENTARIO", 
			"COMENTARIO_LINHA", "WS"
		};
	}
