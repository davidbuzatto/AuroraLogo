...
public class AuroraLogoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"UNICODE", "ABA", "ABE", "ALT", "ATE", "BAI", "CADA", "CAM", "CIM", "COD", 
			"COM", "CONT", "CON", "COR", "CUBI", "CUR", "CRA", "CRAA", "CRR", "CRRA", 
			"DCMM", "DE", "DES", "DESE", "DIAG", "DIR", "DIVM", "DO", "E", "EM", 
			"ENG", "ENQ", "ENT", "ESCO", "ESC", "ESQ", "FAL", "FEC", "FORM", "FUN", 
			"FUNC", "GIR", "GRA", "GROS", "INCM", "INI", "LER", "LEV", "LIM", "LIN", 
			"MOV", "MULM", "NA", "NO", "PADR", "PARA", "PARR", "PI", "PINC", "PIZ", 
			"POR", "PREE", "PUL", "QUAD", "RAD", "REP", "REPE", "RET", "SAI", "SE", 
			...
			"PA", "PX", "PY", "CARC", "CHAV", "COMP", "SUBS", "F_ACOS", "F_ARRE", 
			...
			"NAOT", "DOT", "ID", "IDC", "IDF", "IDP", "IDA", "INT", "DEC", "CHEX", 
