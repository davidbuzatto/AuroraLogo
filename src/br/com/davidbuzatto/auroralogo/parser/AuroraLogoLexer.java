...
public class AuroraLogoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ESCC", "UNICODE", "PX", "PY", "PA", "ABA", "ABE", "ATE", "BAI", "CAM", 
			"CIM", "COD", "COM", "CONT", "COR", "CUBI", "CUR", "DCMM", "DE", "DES", 
			"DESE", "DIAG", "DIR", "DIVM", "DO", "EM", "ENG", "ENQ", "ENT", "ESCO", 
