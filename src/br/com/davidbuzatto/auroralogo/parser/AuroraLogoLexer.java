...
public class AuroraLogoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"VERMELHO", "BRANCO", "AMARELO", "ESCURO", "CLARO", "PA", "PCF", "PCP", 
			"PCPP", "PCPR", "PD", "PES", "PG", "PX", "PY", "CARC", "CHAV", "COMP", 
			"SUBS", "TIPO", "F_ACOS", "F_ARRE", "F_ASEN", "F_ATAN", "F_CAPO", "F_CHAO", 
			...
			"FC_CRI", "FG_ARC", "FG_CCU", "FG_CIC", "FG_CQD", "FG_ELI", "FG_EST", 
