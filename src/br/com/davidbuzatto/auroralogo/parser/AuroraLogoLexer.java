...
public class AuroraLogoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"VEZ", "VEZS", "NA", "SAI", "INCM", "DCMM", "SOMM", "SUBM", "MULM", "DIVM", 
			...
			"F_COSH", "F_TANH", "F_LOGA", "F_GRRA", "F_RAGR", "F_INC", "F_DCM", "ATR", 
			"ATRA", "AC_A", "AT_A", "AC_S", "AT_S", "AC_M", "AT_M", "AC_D", "AT_D", 
			"AC_R", "AT_R", "ADI", "ADIA", "SUB", "SUBA", "MUL", "DIV", "DIVA", "POR", 
