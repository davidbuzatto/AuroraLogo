...
public class AuroraLogoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "T__7", "LETmin", 
			"LETmai", "LET", "LETAmin", "LETAmai", "LETA", "DIG", "DHX", "ESCC", 
			"UNICODE", "A", "ABA", "ABE", "ALT", "ATE", "BAI", "CADA", "CAM", "CIM", 
			"COD", "COM", "CONT", "CONU", "CON", "CONE", "CONS", "COR", "CUBI", "CUR", 
			"CRA", "CRAA", "CRR", "CRRA", "DCMM", "DE", "DES", "DESE", "DIAG", "DIR", 
			"DIVM", "DO", "E", "EM", "ENG", "ENQ", "ENT", "ESCO", "ESC", "ESQ", "EST", 
			"FAL", "FEC", "FORM", "FUN", "FUNC", "GIR", "GRA", "GROS", "INCM", "INI", 
			"LER", "LEV", "LIM", "LIN", "MEN", "MOS", "MOV", "MULM", "NA", "NO", 
			"PAS", "PADR", "PARA", "PARR", "PI", "PINC", "PIZ", "PONT", "POR", "PREE", 
			"PUL", "QUAD", "RAD", "REP", "RET", "SAI", "SE", "SEN", "SEM", "SOMM", 
			"SUBM", "TART", "TER", "TRAC", "TROC", "USA", "VA", "VER", "VEZ", "VEZS", 
			"PRETO", "AZUL", "CIANO", "CINZA", "VERDE", "MAGENTA", "LARANJA", "ROSA", 
			"VERMELHO", "BRANCO", "AMARELO", "ROXO", "ESCURO", "CLARO", "PA", "PCF", 
			"PCP", "PCPP", "PCPR", "PD", "PES", "PG", "PX", "PY", "CARC", "CHAV", 
			...
			"F_VABS", "FC_CRI", "FCO_INT", "FCO_DEC", "FCO_CHR", "FCO_BOL", "FCO_STR", 
			"FCO_COR", "FG_ARC", "FG_CCU", "FG_CIC", "FG_CQD", "FG_ELI", "FG_EST", 
