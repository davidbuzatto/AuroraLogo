...
public class AuroraLogoErrorListener extends BaseErrorListener {
    ...
    public AuroraLogoErrorListener( RSyntaxTextArea textAreaCodigo, JTextPane textPaneSaida, JanelaPrincipal janelaPrincipal, PainelDesenho painelDesenho, Tartaruga tartaruga ) {
    ...
    public void syntaxError( Recognizer<?, ?> recognizer,
        ...
        Utils.inserirTextoFormatado( textPaneSaida, "rule stack: " + stack + "\n", Color.RED );
        Utils.inserirTextoFormatado( textPaneSaida, "line " + line + ":" + charPositionInLine + " at " + offendingSymbol + ": " + msg + "\n", Color.RED );
