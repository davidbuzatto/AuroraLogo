 ...
 * @author David
 */
public class DesenhistaAuroraLogoVisitorBack extends AuroraLogoBaseVisitor<Integer> {

    /*private Tartaruga tartaruga;
    private JanelaPrincipal janelaPrincipal;
    
    public DesenhistaAuroraLogoVisitorBack( Tartaruga tartaruga, JanelaPrincipal janelaPrincipal ) {
